...
<head>
    ...
    <!-- Title  -->
    <title>AliMel.it | create new order</title>
                ...
                <div class="row">
                    <div class="col-12 col-lg-8">
                        <div class="checkout_details_area mt-50 clearfix">
                            ...
                            <form action="setneworder.php" method="post">
                                <div class="row">
                                    <div class="col-md-5 mb-3">
                                        <input type="number" class="form-control" id="n_articles" name="n_articles" min="1" max='99' maxlength="2" placeholder="Quantity of articles" value="" required>
                                    </div>
                                    ...
                                    <div class="col-12 mb-1">
                                        <div class="cart-btn mt-100">
                                            <button type="submit" class="btn amado-btn mb-15" name="register">create</button></br></br>
                                        </div>
                                    </div>
                                </div>
                            </form>
