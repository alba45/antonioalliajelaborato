...
<head>
    ...
    <!-- Title  -->
    <title>AliMel.it | Home: admin</title>
        ...
        <div class="products-catagories-area clearfix">
            <div class="amado-pro-catagory clearfix">
                ...
                <div class="single-products-catagory clearfix">
                    <a href="registerworkerindex.php">
                        <img src="../../img/bg-img/1.jpg" alt="">
                        <!-- Hover Content -->
                        <div class="hover-content">
                            <div class="line"></div>
                            <p>create new worker account</p>
                            <h4>NEW WORKER</h4>
                        </div>
                    </a>
                </div>
                ...
                <!-- Single Catagory -->
                <div class="single-products-catagory clearfix">
                    <a href="assignwork.php">
                        <img src="../../img/bg-img/2.jpg" alt="">
                        <!-- Hover Content -->
                        <div class="hover-content">
                            <div class="line"></div>
                            <p>assign work to your workers</p>
                            <h4>ASSIGN WORK</h4>
                        </div>
                    </a>
                </div>
