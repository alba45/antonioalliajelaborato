                        ...
                        <div class="checkout_details_area mt-50 clearfix">
                            ...
                            <form action="registerworker.php" method="post">
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-3">
                                        <input type="password" class="form-control" id="password" name="password" placeholder="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Deve contenere almeno un numero, un carattere maiuscolo, e almeno 8 o più caratteri" required>
                                    </div></br>
                                    <div class="col-md-6 mb-3">
                                    ...
                                    <div class="col-12 mb-3">
                                        <div class="cart-btn mt-100">
                                            ...
                                            <a>Do you want to create an admin account? Click down below.</a></br></br>
                                            <a href="registeradminindex.php" class="btn amado-btn mb-15">New admin</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
